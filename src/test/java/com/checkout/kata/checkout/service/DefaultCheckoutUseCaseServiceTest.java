...
class DefaultCheckoutUseCaseServiceTest {

    @Mock
    private ReadItemStorageService readItemStorageService;

    @InjectMocks
    private DefaultCheckoutUseCaseService underTest;

    @Test
    void handle_shouldCalculateCheckout_whenScannedItemProvided(){
        //given
        String name1 = "Apple";
        int quantity1 = 1;
        String name2 = "Banana";
        ...
        when(readItemStorageService.findByNames(any())).thenReturn(itemsMap);

        CheckoutResponse response = underTest.handle(new CheckoutRequest(scannedItems));
    ...
    @Test
    void handle_shouldCalculateCheckout_whenScannedItemProvided_test2(){
        //given
        String name1 = "Apple";
        int quantity1 = 1;
        String name2 = "Banana";
    ...
    @Test
    void handle_shouldCalculateCheckout_whenScannedItemProvided_test3(){
        //given
        String name1 = "Apple";
        int quantity1 = 4;
        String name2 = "Banana";
    ...
    @Test
    void handle_shouldCalculateCheckout_whenScannedItemProvided_test4(){
        //given
        String name1 = "kiwi";
        int quantity1 = 4;
        String name2 = "Banana";
    ...
    @Test
    void handle_shouldCalculateCheckout_whenScannedItemProvided_test5(){
        //given
        String name1 = "Apple";
        int quantity1 = 4;
        String name2 = "Banana";
